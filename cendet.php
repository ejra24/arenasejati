...
// DAFTAR KELAS AKTIF KHUSUS CENDET (Brosur Marwah Murai Borneo)
$kelas_cendet = [
    4  => ["nama" => "Sesi 4 - Cendet Tilas", "harga" => 55000],
    10 => ["nama" => "Sesi 10 - Cendet Marwah", "harga" => 125000],
    19 => ["nama" => "Sesi 19 - Cendet Napak", "harga" => 85000],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action_booking'])) {
    ...
    $harga_satuan = $kelas_cendet[$id_kelas_pilih]['harga'] ?? 55000;
    ...
    $merchantOrderId    = 'CDT-' . $id_transaksi_lokal . '-' . time();
    ...
    $params = [
        ...
        'returnUrl'       => 'http://127.0.0.1/kasirBurung/cendet.php',
        'expiryPeriod'    => 10,
        'signature'       => $signature
    ];
...
if (isset($_GET['get_status_kelas'])) {
    ...
    if (!array_key_exists($id_req, $kelas_cendet)) {
        echo json_encode(['error' => 'Kelas tidak ditemukan']);
        exit;
    }
    
    $nama_kelas_req = $kelas_cendet[$id_req]['nama'];
    ...
    echo json_encode([
        'harga' => $kelas_cendet[$id_req]['harga'],
...
// Data awal saat pertama kali halaman diakses (Sesi 4)
$id_awal = 4;
$nama_kelas_awal = $kelas_cendet[$id_awal]['nama'];
$harga_awal = $kelas_cendet[$id_awal]['harga'];
...
<div class="main-wrapper" style="margin-top: 100px;">
    <div class="left-column">
        ...
        <div class="seat-section">
            ...
            <h2>Area Pemilihan Gantangan - Cendet</h2>
            ...
            <div class="select-kelas-box">
                ...
                <select id="id_kelas_pilih" onchange="muatUlangKomponenKelas(this.value)">
                    <?php foreach($kelas_cendet as $id => $item): ?>
...
<script>
    ...
    const daftarNamaKelas = <?php
        $js_array = [];
        foreach($kelas_cendet as $id => $item) { $js_array[$id] = $item['nama']; }
