...
// DAFTAR KELAS AKTIF (KHUSUS HALAMAN CUCAK IJO)
$kelas_cucak_ijo = [
    3  => ["nama" => "Sesi 3 - Cucak Ijo Tilas", "harga" => 55000],
    9  => ["nama" => "Sesi 9 - Cucak Ijo (A) Napak", "harga" => 85000],
    14 => ["nama" => "Sesi 14 - Cucak Ijo Sultan", "harga" => 220000],
    18 => ["nama" => "Sesi 18 - Cucak Ijo Marwah", "harga" => 125000],
    23 => ["nama" => "Sesi 23 - Cucak Ijo (B) Napak", "harga" => 85000],
];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action_booking'])) {
    ...
    // Tangkap metode pembayaran (Default ke QRIS jika tidak ada)
    ...
    $harga_satuan = $kelas_cucak_ijo[$id_kelas_pilih]['harga'] ?? 55000;
    ...
    // Penangkapan deskripsi (bisa diisi manual dari form atau default)
    ...
    $merchantOrderId    = 'CIJO-' . $id_transaksi_lokal . '-' . time();
    ...
    $params = [
        ...
        'returnUrl'       => 'http://127.0.0.1/kasirBurung/cucakijo.php',
        'expiryPeriod'    => 10,
        'signature'       => $signature
    ];
...
if (isset($_GET['get_status_kelas'])) {
    ...
    if (!array_key_exists($id_req, $kelas_cucak_ijo)) {
        echo json_encode(['error' => 'Kelas tidak ditemukan']);
        exit;
    }

    $nama_kelas_req = $kelas_cucak_ijo[$id_req]['nama'];
    ...
    echo json_encode([
        'harga' => $kelas_cucak_ijo[$id_req]['harga'],
...
// Data awal saat pertama kali halaman diakses (Sesi 3)
$id_awal = 3;
$nama_kelas_awal = $kelas_cucak_ijo[$id_awal]['nama'];
$harga_awal = $kelas_cucak_ijo[$id_awal]['harga'];
...
<div class="main-wrapper" style="margin-top: 100px;">
    <div class="left-column">
        ...
        <div class="seat-section">
            ...
            <h2>Area Pemilihan Gantangan - Cucak Ijo</h2>
            ...
            <div class="select-kelas-box">
                ...
                <select id="id_kelas_pilih" onchange="muatUlangKomponenKelas(this.value)">
                    <?php foreach($kelas_cucak_ijo as $id => $item): ?>
...
<script>
    ...
    const daftarNamaKelas = <?php
        $js_array = [];
        foreach($kelas_cucak_ijo as $id => $item) { $js_array[$id] = $item['nama']; }
